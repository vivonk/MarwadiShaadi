...
public class Notifications_elements {
    ...
    public Notifications_elements(String name, int number, String imgAdd, boolean suggested, boolean interestRec, boolean interestAcc, boolean msgRec, boolean premMem, boolean memExp, boolean reminders, boolean offers, boolean bday) {
        this.name = name;
        this.number=number;
